let quotes = [`"Just keep swimming" - Finding Nemo, 2003`,
...
`"Made it, Ma! Top of the world!" - White Heat, 1949James Bond quote, Bond, James Bond.`,
...
`"Why don't you come up sometime and see me?" - She Done Him Wrong, 1933Dustin Hoffman midnight cowboy`,
...
`"Round up the usual suspects." - Casablanca, 1942Jaws, you're gonna need a bigger boat`,
...
`"Today, I consider myself the luckiest man on the face of the earth." - The Pride of the Forrest gump box of chocolates sceneYankees, 1942`,
...
`"I see dead people." - The Sixth Sense, 1999Stella, Hey Stella scene Streetcar`,
...
`"You had me at ‘hello.’" - Jerry Maguire, 1996league of their own, theres no crying in baseball`,
...
`"As God is my witness, I'll never be hungry again." - Gone With the Wind, 1939Scarface say hello to my little friend scene`,
...
`"Of all the gin joints in all the towns in all the world, she walks into mine." - Casablanca, The Shining heres johnny scene1942`,
...
`"Mother of mercy, is this the end of Rico?" - Little Caesar, 1930Terminator saying hasta la vista baby`,
...
`"Listen to me, mister. You're my knight in shining armor. Don't you forget it. You're James Bond saying a martini shaken not sitrredgoing to get back on that horse, and I'm going to be right behind you, holding on tight, and away we're gonna go, go, go!" - On Golden Pond, 1981`,
`"A martini. Shaken, not stirred." - Goldfinger, 1964`,
`"Who's on first." - The Naughty Nineties, 1945`,
`"Cinderella story. Outta nowhere. A former greenskeeper, now, about to become the Dead Poets Society, Carpe Diem, Seize the day, make your lives extraordinaryMasters champion. It looks like a mirac...It's in the hole! It's in the hole! It's in the hole!"- Caddyshack, 1980`,
...
`"My mother thanks you. My father thanks you. My sister thanks you. And I thank you." - Jack Dawson, Titanic, yelling I'm the King of the worldYankee Doodle Dandy, 1942`,
...
window.setInterval(() => {showRandomQuote()}, 3000);